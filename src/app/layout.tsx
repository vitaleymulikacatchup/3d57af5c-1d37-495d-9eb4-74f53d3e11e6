...
export const metadata: Metadata = {
  title: "SHRED - Premium Skateboards for Gen Z",
  description: "Get premium skateboards built by skaters for skaters. Complete setups, decks, and parts. Free shipping on orders over $100.",
  keywords: ["skateboard", "skate", "skateboarding", "complete skateboard", "skateboard deck", "street skating", "gen z"],
  metadataBase: new URL("https://shred-skateboards.com"),
  alternates: {
    canonical: "https://shred-skateboards.com"
  },
  openGraph: {
    title: "SHRED - Premium Skateboards for Gen Z",
    description: "Premium skateboards built by skaters for skaters. Complete setups ready to ride.",
    siteName: "SHRED",
    images: [{
      url: "https://images.pexels.com/photos/8609350/pexels-photo-8609350.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "Skateboard setup"
    }],
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "SHRED - Premium Skateboards",
    description: "Premium skateboards built by skaters for skaters.",
    images: ["https://images.pexels.com/photos/8609350/pexels-photo-8609350.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
